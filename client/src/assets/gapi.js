 ...
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
  ...
  var Xa = /^(\/[a-zA-Z0-9_\-]+)+$/, Ya = [/\/amp\//, /\/amp$/, /^\/amp$/], Za = /^[a-zA-Z0-9\-_\.,!]+$/,
    ...
    ib = function (a, b, c) {
      ...
      return null
    }, db = /^https?:\/\/[a-z0-9_.-]+\.google(rs)?\.com(:\d+)?\/[a-zA-Z0-9_.,!=\-\/]+$/, cb = /\/cb=/g, bb = /\/\//g,
    jb = function () {
      var a = La(ea.href);
  ...
  var Qb, Q, R = void 0, S = function (a) {
    ...
    ac = /"([^\0-\x1f\\"]|\\[\\\/"bfnrt]|\\u[0-9a-fA-F]{4})*"/g, bc = /-?(0|[1-9][0-9]*)(\.[0-9]+)?([eE][-+]?[0-9]+)?/g,
    cc = /[ \t\n\r]+/g,
...
gapi.load("", {
  ...
  _c: {
    "jsl": {
      ...
      "h": "m;/_/scs/apps-static/_/js/k\u003doz.gapi.vi.YE2t8i3yGlc.O/am\u003dQQ/rt\u003dj/d\u003d1/rs\u003dAGLTcCOqaYSoJy29mbtCcW23rA6VpXuC-g/m\u003d__features__",
      "u": "https://apis.google.com/js/platform.js",
      "hee": true,
      "fp": "6982446dde840d8a62a18c286282aeac4c6f2c28",
      "dpo": false
    },
